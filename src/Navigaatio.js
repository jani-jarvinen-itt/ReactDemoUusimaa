  ...
  render() {
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <a className="navbar-brand" href="testi">Navbar</a>
            ...
            <ul className="navbar-nav">
                ...
                <a className="nav-link" href="testi">Home <span className="sr-only">(current)</span></a>
                </li>
                <li className="nav-item">
                <a className="nav-link" href="testi">Features</a>
                </li>
                <li className="nav-item">
